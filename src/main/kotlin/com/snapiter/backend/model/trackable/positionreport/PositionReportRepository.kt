...
interface PositionReportRepository : ReactiveCrudRepository<PositionReport, Long> {
    ...
    fun findAllByTrackableIdAndCreatedAtIsBetweenOrderByCreatedAtDesc(trackableId: String, fromDate : Instant, untilDate: Instant, offset: Int, limit: Int): Flux<PositionReport>
